...
class Handyman: UITableViewController {
    ...
    override func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        return App.sharedInstance.getAllObjectsByType(App.sharedInstance.handymanTypeString).count
    }
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let item = App.sharedInstance.getAllObjectsByType(App.sharedInstance.handymanTypeString)[indexPath.row]
